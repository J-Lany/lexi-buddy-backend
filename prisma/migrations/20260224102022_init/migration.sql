...
-- CreateEnum
CREATE TYPE "StudentAttemptStatus" AS ENUM ('IN_PROGRESS', 'COMPLETED', 'GRADED');
...
-- CreateTable
CREATE TABLE "StudentAssignedAssignment" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "assignmentId" INTEGER NOT NULL,
    ...
    CONSTRAINT "StudentAssignedAssignment_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "StudentAssignmentAttempt" (
    "id" SERIAL NOT NULL,
    "assignedId" INTEGER NOT NULL,
    "attemptNo" INTEGER NOT NULL,
    "status" "StudentAttemptStatus" NOT NULL DEFAULT 'IN_PROGRESS',
    "score" DOUBLE PRECISION,
    "startedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "submittedAt" TIMESTAMP(3),
    "gradedAt" TIMESTAMP(3),

    CONSTRAINT "StudentAssignmentAttempt_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "StudentAssignedAssignment_userId_idx" ON "StudentAssignedAssignment"("userId");

-- CreateIndex
CREATE INDEX "StudentAssignedAssignment_assignmentId_idx" ON "StudentAssignedAssignment"("assignmentId");

-- CreateIndex
CREATE UNIQUE INDEX "StudentAssignedAssignment_userId_assignmentId_key" ON "StudentAssignedAssignment"("userId", "assignmentId");

-- CreateIndex
CREATE INDEX "StudentAssignmentAttempt_assignedId_idx" ON "StudentAssignmentAttempt"("assignedId");

-- CreateIndex
CREATE UNIQUE INDEX "StudentAssignmentAttempt_assignedId_attemptNo_key" ON "StudentAssignmentAttempt"("assignedId", "attemptNo");
...
-- AddForeignKey
ALTER TABLE "StudentAssignedAssignment" ADD CONSTRAINT "StudentAssignedAssignment_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentAssignedAssignment" ADD CONSTRAINT "StudentAssignedAssignment_assignmentId_fkey" FOREIGN KEY ("assignmentId") REFERENCES "Assignment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentAssignmentAttempt" ADD CONSTRAINT "StudentAssignmentAttempt_assignedId_fkey" FOREIGN KEY ("assignedId") REFERENCES "StudentAssignedAssignment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_attemptId_fkey" FOREIGN KEY ("attemptId") REFERENCES "StudentAssignmentAttempt"("id") ON DELETE CASCADE ON UPDATE CASCADE;
